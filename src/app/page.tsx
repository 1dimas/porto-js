          ...
          >
            <div>
              ...
              <p className="text-lg text-white mb-6">
                Saya Dimas Dwi A.P, seorang pengembang web yang antusias dan selalu ingin berkembang. Saya percaya bahwa teknologi adalah alat untuk menciptakan solusi nyata dan berdampak. Saya senang bekerja dalam tim, terbuka pada tantangan baru, dan selalu berusaha memberikan hasil terbaik.
              </p>
              <div className="flex flex-col gap-2">
                <span className="inline-flex items-center gap-2 text-[#C3FF00] font-semibold">
                  <svg width="20" height="20" fill="none"><circle cx="10" cy="10" r="10" fill="#C3FF00" /></svg>
          ...
          >
            <div className="flex justify-center md:justify-end">
              <Image
                ...
                width={350}
                height={350}
                className="rounded-2xl shadow-lg border-2 border-[#C3FF00]/30 bg-[#181e2e]"
              />
            </div>
          </AnimatedContent>
        </div>
      ...
      <section className="py-24 bg-[#10172b]">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
            <AnimatedContent distance={60} direction="vertical" duration={0.7} threshold={0.1}>
              <div className="group flex flex-col items-center bg-[#181e2e] rounded-xl p-6 border border-[#2f3b59] hover:scale-105 transition-transform shadow-md hover:shadow-[#C3FF00]/30">
                <span className="text-[#61dafb] text-5xl mb-2">
                  {/* React Icon */}
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="20" r="20" fill="#181e2e"/><g><ellipse rx="8" ry="20" transform="matrix(.87 .5 -.5 .87 20 20)" stroke="#61dafb" strokeWidth="2"/><ellipse rx="8" ry="20" transform="matrix(.87 -.5 .5 .87 20 20)" stroke="#61dafb" strokeWidth="2"/><ellipse rx="8" ry="20" transform="matrix(0 1 1 0 20 20)" stroke="#61dafb" strokeWidth="2"/><circle cx="20" cy="20" r="3" fill="#61dafb"/></g></svg>
                </span>
                <span className="text-white font-semibold text-lg">React</span>
                <div className="w-full h-2 bg-[#2f3b59] rounded mt-3">
                  <div className="h-2 bg-[#61dafb] rounded" style={{ width: "90%" }} />
                </div>
              </div>
            </AnimatedContent>
            <AnimatedContent distance={60} direction="vertical" duration={0.8} threshold={0.1}>
              <div className="group flex flex-col items-center bg-[#181e2e] rounded-xl p-6 border border-[#2f3b59] hover:scale-105 transition-transform shadow-md hover:shadow-[#C3FF00]/30">
                <span className="text-[#fff] text-5xl mb-2">
                  {/* Next.js Icon */}
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="20" r="20" fill="#181e2e"/><text x="10" y="28" fontSize="18" fill="#fff" fontFamily="Arial">N</text></svg>
                </span>
                <span className="text-white font-semibold text-lg">Next.js</span>
                <div className="w-full h-2 bg-[#2f3b59] rounded mt-3">
                  <div className="h-2 bg-white rounded" style={{ width: "85%" }} />
                </div>
              </div>
            </AnimatedContent>
            <AnimatedContent distance={60} direction="vertical" duration={0.9} threshold={0.1}>
              <div className="group flex flex-col items-center bg-[#181e2e] rounded-xl p-6 border border-[#2f3b59] hover:scale-105 transition-transform shadow-md hover:shadow-[#C3FF00]/30">
                <span className="text-[#38bdf8] text-5xl mb-2">
                  {/* Tailwind Icon */}
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="20" r="20" fill="#181e2e"/><path d="M13 23c1.5-3 3.5-4.5 6-4.5s4.5 1.5 6 4.5c-1.5 3-3.5 4.5-6 4.5s-4.5-1.5-6-4.5z" fill="#38bdf8"/><path d="M19 17c1-2 2.5-3 4-3s3 1 4 3c-1 2-2.5 3-4 3s-3-1-4-3z" fill="#38bdf8"/></svg>
                </span>
                <span className="text-white font-semibold text-lg">TailwindCSS</span>
                <div className="w-full h-2 bg-[#2f3b59] rounded mt-3">
                  <div className="h-2 bg-[#38bdf8] rounded" style={{ width: "80%" }} />
                </div>
              </div>
            </AnimatedContent>
            <AnimatedContent distance={60} direction="vertical" duration={1} threshold={0.1}>
              <div className="group flex flex-col items-center bg-[#181e2e] rounded-xl p-6 border border-[#2f3b59] hover:scale-105 transition-transform shadow-md hover:shadow-[#C3FF00]/30">
                <span className="text-[#fff] text-5xl mb-2">
                  {/* Three.js Icon */}
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="20" r="20" fill="#181e2e"/><polygon points="20,10 30,30 10,30" fill="#fff"/><polygon points="20,14 27,28 13,28" fill="#000"/></svg>
                </span>
                <span className="text-white font-semibold text-lg">Three.js</span>
                <div className="w-full h-2 bg-[#2f3b59] rounded mt-3">
                  <div className="h-2 bg-[#fff] rounded" style={{ width: "70%" }} />
                </div>
              </div>
            </AnimatedContent>
          </div>
      ...
      <section className="py-24">
        <div className="container mx-auto">
          ...
          <div className="flex gap-8 overflow-x-auto pb-4">
            <AnimatedContent distance={60} direction="horizontal" duration={0.7} threshold={0.1}>
              <div className="min-w-[320px] bg-[#181e2e] rounded-xl border border-[#2f3b59] shadow-md hover:shadow-[#C3FF00]/30 transition-shadow flex flex-col">
                <Image src="/project1-thumb.jpg" alt="Project 1" width={320} height={180} className="rounded-t-xl object-cover" />
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-xl font-bold text-white mb-2">Portofolio 3D Interactive</h3>
                  <p className="text-white/80 mb-3 text-sm">Website portofolio dengan animasi 3D interaktif menggunakan React Three Fiber dan Next.js.</p>
                  <div className="flex gap-2 mb-4">
                    <span className="bg-[#C3FF00] text-black px-2 py-1 rounded text-xs font-semibold">Next.js</span>
                    <span className="bg-[#181e2e] border border-[#C3FF00] text-[#C3FF00] px-2 py-1 rounded text-xs font-semibold">Three.js</span>
                  </div>
                  <a href="#" target="_blank" rel="noopener noreferrer" className="mt-auto inline-block px-4 py-2 bg-[#C3FF00] text-black font-bold rounded hover:bg-[#b3e600] transition">View Project</a>
                </div>
              </div>
            </AnimatedContent>
            <AnimatedContent distance={60} direction="horizontal" duration={0.8} threshold={0.1}>
              <div className="min-w-[320px] bg-[#181e2e] rounded-xl border border-[#2f3b59] shadow-md hover:shadow-[#C3FF00]/30 transition-shadow flex flex-col">
                <Image src="/project2-thumb.jpg" alt="Project 2" width={320} height={180} className="rounded-t-xl object-cover" />
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-xl font-bold text-white mb-2">Sistem Absensi Siswa</h3>
                  <p className="text-white/80 mb-3 text-sm">Aplikasi absensi berbasis web dengan dashboard realtime dan autentikasi.</p>
                  <div className="flex gap-2 mb-4">
                    <span className="bg-[#C3FF00] text-black px-2 py-1 rounded text-xs font-semibold">React</span>
                    <span className="bg-[#181e2e] border border-[#C3FF00] text-[#C3FF00] px-2 py-1 rounded text-xs font-semibold">Firebase</span>
                  </div>
                  <a href="#" target="_blank" rel="noopener noreferrer" className="mt-auto inline-block px-4 py-2 bg-[#C3FF00] text-black font-bold rounded hover:bg-[#b3e600] transition">View Project</a>
                </div>
              </div>
            </AnimatedContent>
            <AnimatedContent distance={60} direction="horizontal" duration={0.9} threshold={0.1}>
              <div className="min-w-[320px] bg-[#181e2e] rounded-xl border border-[#2f3b59] shadow-md hover:shadow-[#C3FF00]/30 transition-shadow flex flex-col">
                <Image src="/project3-thumb.jpg" alt="Project 3" width={320} height={180} className="rounded-t-xl object-cover" />
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-xl font-bold text-white mb-2">Landing Page Modern</h3>
                  <p className="text-white/80 mb-3 text-sm">Landing page responsif dengan animasi scroll dan integrasi API.</p>
                  <div className="flex gap-2 mb-4">
                    <span className="bg-[#C3FF00] text-black px-2 py-1 rounded text-xs font-semibold">Next.js</span>
                    <span className="bg-[#181e2e] border border-[#C3FF00] text-[#C3FF00] px-2 py-1 rounded text-xs font-semibold">TailwindCSS</span>
                  </div>
                  <a href="#" target="_blank" rel="noopener noreferrer" className="mt-auto inline-block px-4 py-2 bg-[#C3FF00] text-black font-bold rounded hover:bg-[#b3e600] transition">View Project</a>
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-xl">
          ...
          <form className="bg-[#181e2e] rounded-xl p-8 border border-[#2f3b59] shadow-lg flex flex-col gap-6">
            ...
            <div className="text-center text-white/70 mt-2">
              Email: <a href="mailto:dimas@email.com" className="text-[#C3FF00] underline">dimas@email.com</a>
            </div>
          </form>
        </div>
      </section>
      ...
      <footer className="bg-[#0A1021] py-8 border-t border-[#2f3b59]">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white text-center md:text-left">
            Dimas Dwi A.P &copy; {new Date().getFullYear()} &middot; All rights reserved.
          </div>
          <div className="flex gap-5 justify-center">
            <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="text-[#C3FF00] hover:text-white transition text-2xl">
              {/* GitHub Icon */}
            ...
            <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="text-[#C3FF00] hover:text-white transition text-2xl">
              {/* LinkedIn Icon */}
            ...
            <a href="https://instagram.com/yourusername" target="_blank" rel="noopener noreferrer" className="text-[#C3FF00] hover:text-white transition text-2xl">
              {/* Instagram Icon */}
